...
describe('User model', function() {
  ...
  beforeEach(function() {
    bio =
      "Once upon a time I knew nothing of databases. Today, I dream in SQL and experience the world through tables and rows. I'm currently a single entity but I'm looking for someone else to JOIN me in a RELATIONship. If you enjoy puns as much as I do, send me a query and we can SELECT a time to meet.";
  ...
  describe('options:', function() {
    ...
    describe('`haveBirthday` instance method', function() {
      ...
      it("the returned promise resolves to the user's new age", function() {
        return user.save().then(function() {
          return user.haveBirthday().then(function(olderUser) {
